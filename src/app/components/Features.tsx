				...
				<div className="mt-32 max-w-7xl mx-auto">
					<div className="mb-16 max-w-2xl text-center mx-auto">
						...
						<p className="text-gray-400">
							Here is a curated list of features 
						</p>
					</div>
					<div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12 mt-16">
						<div className="text-center bg-[#111] px-6 py-8 rounded-2xl">
							...
							<p className="text-gray-400">
								Customize our product to perfectly align with
								your brand and meet your unique requirements.
							</p>
						</div>
						<div className="text-center bg-[#111] px-6 py-8 rounded-2xl">
							<svg
							...
							<p className="text-gray-400">
								Rest easy knowing that your data is safeguarded
								by the latest and most robust security measures
								available.
							</p>
						</div>
						<div className="text-center bg-[#111] px-6 py-8 rounded-2xl">
							...
							<h3 className="text-xl mb-4">
								Follows the AI Trend
							</h3>
							<p className="text-gray-400">
								All the model and infrastructure are in phase of constant updates to meet the competition needs globally.
							</p>
						</div>
					</div>
				</div>
